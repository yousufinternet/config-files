...
(set-face-attribute 'fixed-pitch nil :family "Fira Code" :height 135 :weight 'light :fontset "fontset-default")
...
(set-fontset-font "fontset-proportional" 'latin (font-spec :family "Fira Sans" :height 135))
...
#+BEGIN_SRC emacs-lisp
    ...
    ;; modus-vivendi-theme
  (setq themes-list '(gotham-theme kaolin-themes zerodark-theme spacemacs-theme ample-theme doom-themes modus-themes))
...
;; couldn't find hooks when changing themes
(defun my-load-theme (theme-name)
...
(reapply-font)
  ...
  (my-load-theme default-dark-theme)
#+END_SRC
