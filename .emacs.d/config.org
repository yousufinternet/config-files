...
(set-fontset-font "fontset-proportional" nil (font-spec :family "Noto Sans" :height 135))
(set-fontset-font "fontset-proportional" 'arabic (font-spec :family "Noto Sans Arabic" :height 135))
(set-face-attribute 'variable-pitch nil :font "fontset-proportional" :fontset "fontset-proportional")
