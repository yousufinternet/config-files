...
mu4e-attachment-dir "~/Downloads/MailDownloads"
mu4e-view-show-images t
mu4e-view-show-addresses t
mu4e-compose-format-flowed t
message-kill-buffer-on-exit t
mu4e-headers-fields '((:empty 2) (:human-date . 12) (:flags . 6) (:from-or-to . 20) (:thread-subject))
)
...
(:name "Unread messages" :query "flag:unread AND NOT flag:trashed" :key 117)
 ...
 (:name "Messages with xlsx" :query "mime:application/application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" :key ?x)
...
** mu4e alerts
#+begin_src emacs-lisp
(use-package mu4e-alert :after mu4e)
#+end_src
* Dired
