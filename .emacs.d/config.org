...
(set-face-attribute 'org-checkbox nil :inherit 'fixed-pitch :weight 'bold :foreground "#b5bd68")
)
...
** Themes عربي 
    Noto sans might look ok when in regular weight, but it looks horrible when in bold weight
#+BEGIN_SRC emacs-lisp
