...
(set-fontset-font "fontset-proportional" 'arabic (font-spec :family "Noto Sans Arabic" :height 105))
...
(org-babel-do-load-languages 'org-babel-load-languages
  '((shell . t) (python . t) (emacs-lisp . t) (ledger . t) (latex . t)))
...
(setq org-agenda-window-setup "only-window"
      ...
      org-agenda-files (directory-files-recursively "~/Public/Syncthing Global/Notes/" "\\.org$"))
(setq org-agenda-category-icon-alist nil)
(add-to-list 'org-agenda-category-icon-alist '("WORK" ("💼") nil nil :width (16.) :ascent center))
(add-to-list 'org-agenda-category-icon-alist '("SETUP" ("🐧") nil nil :width (16.) :ascent center))
(add-to-list 'org-agenda-category-icon-alist '("EMAIL" ("✉️") nil nil :width (16.) :ascent center))
(add-to-list 'org-agenda-category-icon-alist '("HOME" ("🏠") nil nil :width (16.) :ascent center))
