...
"** %?\n %a\n CAPTURED on: %t\n")
     ("d" "Download Queue" entry (file+headline "~/Public/Syncthing Global/Notes/capture.org" "Download Queue")
"** %?\n %a\n CAPTURED on: %t\n")
     ("c" "Code Notes")
     ("cc" "Code Notes" entry (file+olp "~/Public/Syncthing Global/Notes/capture.org" "Code Notes" "General")
"** %?\n %x\n %t")
     ("cp" "Code Notes" entry (file+olp "~/Public/Syncthing Global/Notes/capture.org" "Code Notes" "Python tricks")
"** %?\n %x\n %t")
     ("co" "Org Tricks" entry (file+olp "~/Public/Syncthing Global/Notes/capture.org" "Code Notes" "Org-tricks")
"** TODO %?\n %x\n %t\n")
     ("cm" "Org Tricks" entry (file+olp "~/Public/Syncthing Global/Notes/capture.org" "Code Notes" "My Code")
"** TODO %?\n %f\n %x\n %t\n")
)
)
   #+END_SRC
