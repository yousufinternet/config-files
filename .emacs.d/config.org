...
(set-fontset-font "fontset-proportional" 'arabic (font-spec :family "Greta Arabic" :weight 'light))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq default-theme 'doom-tomorrow-night)
...
(org-babel-do-load-languages 'org-babel-load-languages
  ...
  (setq org-todo-keywords '((sequence "TODO(t)" "INPROGRESS(i)" "|" "DONE(d)" "CANCELLED(c)" "DELEGATED"))
	...
	'(("CANCELLED"  :foreground "#ff5555" :weight bold)
	  ("DELEGATED"  :foreground "#d75fd7" :weight bold))
	org-log-done 'note
	org-imenu-depth 3
...
(use-package svg-tag-mode :config (setq svg-tag-tags
      '((" TODO " . ((lambda (tag) (svg-lib-tag "TODO"
 '(:margin 2 :padding 2 :background "#f95" :foreground "#000" :radius 5 :font-weight "bold" :end -1)))))
(" CANCELLED " . ((lambda (tag) (svg-lib-tag "CANC"
 '(:margin 2 :padding 2 :background "#955" :foregorund "#f55" :radius 5 :end -1)))))
(" INPROGRESS " . ((lambda (tag) (svg-lib-tag "PROG"
 '(:margin 2 :padding 2 :background "#09f" :foregorund "#fff" :radius 5 :end -1)))))
(" DONE " . ((lambda (tag) (svg-lib-tag "DONE"
 '(:margin 2 :padding 2 :background "#080" :foregorund "#030" :radius 5 :end -1)))))
(" DELEGATED " . ((lambda (tag) (svg-lib-tag "DELG"
 '(:margin 2 :padding 2 :background "#922" :foregorund "#fcc" :radius 5 :end -1)))))
))
)
#+END_SRC
** Agenda
...
(defun format-sort-agenda () (interactive)
 (setcar org-agenda-prefix-format '(agenda . "  %-2i  %?-6 t%s"))
