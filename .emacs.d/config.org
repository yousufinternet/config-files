...
#+BEGIN_SRC emacs-lisp
	(use-package general :ensure t
	  ...
	  (general-define-key
	   ...
	   "fch" (lambda () (interactive) (find-file "~/.config/herbstluftwm/autostart.org"))
	   ...
	   :non-normal-prefix "C-SPC o"
	    ...
	    "f" '(:ignore t :which-key "Files")
            "fa" 'org-attach
            "fr" 'org-archive-default-command
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-fontset-font t 'emoji '("JoyPixels" . "iso10646-1") nil 'prepend)
  ...
  ;; (set-fontset-font "fontset-proportional" 'emoji (font-spec :family "JoyPixels"))
  (set-face-attribute 'variable-pitch nil :fontset "fontset-proportional")
  ...
  ;; (set-face-attribute 'emoji nil :family "Noto Color Emoji")
...
(setq default-dark-theme 'ef-night)
...
#+BEGIN_SRC emacs-lisp
    ...
    (org-babel-do-load-languages 'org-babel-load-languages
      ...
      (setq org-todo-keywords '((sequence "TODO(t)" "NEXT(n)" "|" "DONE(d)" "CANCELLED(c)"))
	    ...
	    org-log-done 'note
            org-link-elisp-skip-confirm-regexp "(find-file"
	    org-imenu-depth 3)
