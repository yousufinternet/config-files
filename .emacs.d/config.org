...
#+RESULTS:
| (lambda (frame) (let ((old-frame (selected-frame)) (old-buffer (current-buffer))) (unwind-protect (progn (select-frame frame 'norecord) (load-theme default-theme t)) (if (frame-live-p old-frame) (progn (select-frame old-frame 'norecord))) (if (buffer-live-p old-buffer) (progn (set-buffer old-buffer)))))) | reapply-font | doom-modeline-refresh-font-width-cache | doom-modeline-set-selected-window | doom-modeline-set-char-widths | evil-init-esc | x-dnd-init-frame |
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq default-theme 'doom-ir-black)
...
:config
(setq org-static-blog-publish-title "Tech Adventurer")
...
"<h3> <a href=\"index.html\"> 🏠 Home </a>|<a href=\"about.html\"> 💀 About </a>|<a href=\"gallary.html\"> 🌄 Photo gallery </a>|<a href=\"index.html\"> 📔 Blog </a>|<a href=\"rss.xml\"> 📢 RSS </a>|<a href=\"mailto:yusuf.mohammad@zoho.com\"> 📧 E-mail</a></h3>\n")
  )
   #+end_src
